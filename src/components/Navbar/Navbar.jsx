...
function Navbar() {
    return (
      <nav className="container py-10 px-2 mx-auto">
        <div className="flex justify-between space-y-5 md:space-y-0 flex-col md:flex-row items-center">
          ...
          <div className="space-x-5 md:space-x-10 flex items-center">
            <a
              href="#features"
              className="hover:text-teal-500 font-opensans transition duration-500"
            >
              Features
            </a>
            <a

...
const Features = () => {
    return (
      <section id="features" className="bg-darkBlue1">
        <div className="grid gap-4 gap-y-20 container mx-auto grid-cols-1 md:grid-cols-2 py-20 font-opensans">
          <div className="text-center space-y-5">
            ...
            <div className="space-y-2 max-w-md mx-auto">
              <h3 className="font-bold text-xl">Acess your file from anywhere</h3>
          ...
          <div className="text-center space-y-5">
            ...
            <div className="space-y-2 max-w-md mx-auto">
              <h3 className="font-bold text-xl"> Security can trust</h3>
              <p className="text-md font-light">
